...
def get_journal_entry_vat(filters):
    ...
    # ---------------------------------------------------------
    # 1) JEs containing VAT accounts (NO f-string formatting)
    # ---------------------------------------------------------
    je_sql = """
        ...
        WHERE je.docstatus = 1
          ...
          {conds}
          AND jea.account IN ({vat_list})
    """.format(
        conds=conditions,
        vat_list=vat_accounts_sql
    )
